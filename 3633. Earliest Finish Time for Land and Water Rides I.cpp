...
//                     res = std::min(landStartTime[i] + landDuration[i] + waterDuration[j], res);
//                 }else{
//                     res = std::min(waterStartTime[j] + waterDuration[j], res);
//                 }
//                 if(waterStartTime[j] + waterDuration[j] >= landStartTime[i]){
//                     res = std::min(waterStartTime[j] + waterDuration[j] + landDuration[i], res);
//                 }else{
//                     res = std::min(landStartTime[i] + landDuration[i], res);
//                 }
//             }
//         }
